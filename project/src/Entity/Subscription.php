...
class Subscription
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\User", mappedBy="subscription", cascade={"persist", "remove"})
     */
    private $user;
    ...
    public function setUser(?User $user): self
    {
        ...
        $newSubscription = $user === null ? null : $this;
        if ($newSubscription !== $user->getSubscription()) {
